...
class DataConfig:
    ...
    def get_data_config(self, data_name):
        ...
        if data_name == 'LEVIR':
            self.root_dir = '/data/lgl/codes/ChangeFormer/data_prepared/LEVIR-CD-256/'
        elif data_name == 'DSIFN':
            self.label_transform = "norm"
            self.root_dir = 'E:/CDDataset/DSIFN_256'
        elif data_name == 'SYSU-CD':
            self.label_transform = "norm"
            self.root_dir = '/data/lgl/codes/ChangeFormer/data_prepared/SYSU-CD/'
            ...
            self.label_transform = "norm"
            self.root_dir = '/data/lgl/codes/ChangeFormer/data_prepared/WHU-CD-256/'
        elif data_name == 'test':
            self.label_transform = "norm"
