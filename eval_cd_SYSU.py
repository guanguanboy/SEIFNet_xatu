...
def main():
    ...
    parser.add_argument('--project_name', default='SYSU-CD_SEIFNet_New', type=str)
    ...
    parser.add_argument('--data_name', default='SYSU-CD', type=str)
    ...
    parser.add_argument('--output_folder', default='output/SYSU_epoch5', type=str)
